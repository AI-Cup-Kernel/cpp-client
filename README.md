...
&nbsp&nbsp1- press the win key and type `edit the system environment variables` and hit enter.<br>
&nbsp&nbsp2- at the bottem of the opened window click environment "variables".<br>
&nbsp&nbsp3- in the "User variavles" find and select "Path", then click edit.<br>
&nbsp&nbsp4- click "New" and paste the path to the bin folder or alternatively click browse and navigate to the bin folder and click ok.<br>
&nbsp&nbsp5- click ok in the previous windows and close them.<br>
