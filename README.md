...
if you couldnt run with make use <code>g++ -std=c++17 -Wall -IC:/libcurl/include  resources/Game.cpp resources/GameHandler.cpp resources/MainProgram.cpp client.cpp -o compile/main -lcurl -LC:/libcurl/lib -pthread</code>
